...
//    
//    init(item: CartItem, onUpdateQuantity: @escaping (Int32) -> Void) {
//        self.item = item
...
//                                quantity = newQuantity  // Update local state
//                                onUpdateQuantity(newQuantity)  // Notify parent
//                            }
//                        }) {
...
//                        
//                        Button(action: {
//                            if quantity < (item.product?.stock ?? 0) && !isUpdating {
//                                let newQuantity = quantity + 1
//                                quantity = newQuantity  // Update local state
//                                onUpdateQuantity(newQuantity)  // Notify parent
//                            }
...
//                                .foregroundColor(.blue)
//                        }
//                        .disabled(quantity >= (item.product?.stock ?? 0) || isUpdating)
//                    }
//                }
//            }
//            
...
//                    .font(.caption)
//                    .foregroundColor(.gray)
//                Text((item.product?.price ?? 0) * Double(quantity), format: .currency(code: "CAD"))
//                    .font(.subheadline)
//                    .fontWeight(.bold)
//                    .foregroundColor(.blue)
//            }
